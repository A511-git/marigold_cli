...
def _valid_kernel_b1(args):
    return args['valid_kernel'](args['B1'])


def _valid_kernel_seg_b1(args):
    return args['valid_kernel_seg'](args['B1'])
...
@triton.heuristics({
    'valid_kernel': _valid_kernel_b1,
    'valid_kernel_seg': _valid_kernel_seg_b1,
